...
public class LerImagemCodigoBarras {
	...
	public LerImagemCodigoBarras(BufferedImage imagem) {
        this.imagem = imagem;
    }
				...
				branco++;
 				...
 				if(teste == true){
 					...
 					if(branco <= (TamanhoPadrao+(TamanhoPadrao/4)) && branco >= (TamanhoPadrao-(TamanhoPadrao/4))){
 						...
 						branco = 0;
 	 	 				teste = false;
 					}else if(branco <= (2*TamanhoPadrao)+(TamanhoPadrao/3) && branco >= ((2*TamanhoPadrao)-(TamanhoPadrao/3))){
 						codigobinario.add("0");
 						codigobinario.add("0");
 						branco = 0;
 						teste = false;
 					}else if(branco <= (3*TamanhoPadrao)+(TamanhoPadrao/2) && branco >= ((3*TamanhoPadrao)-(TamanhoPadrao/2))){
 						codigobinario.add("0");
 						codigobinario.add("0");
 						codigobinario.add("0");
 						branco = 0;
 						teste = false;
 					}else if(branco <= (4*TamanhoPadrao)+(TamanhoPadrao/2) && branco >= ((4*TamanhoPadrao)-(TamanhoPadrao/2))){
 						codigobinario.add("0");
 						codigobinario.add("0");
 						codigobinario.add("0");
 						codigobinario.add("0");
 				...
 				if(teste == true){
	 				...
	 				if(preto <= TamanhoPadrao+(TamanhoPadrao/4) && preto >= TamanhoPadrao-(TamanhoPadrao/4)){
						...
						preto = 0;
	 	 				teste = false;
					}else if(preto <= (2*TamanhoPadrao)+(TamanhoPadrao/3) && preto >= (2*TamanhoPadrao)-(TamanhoPadrao/3)){
						codigobinario.add("1");
						codigobinario.add("1");
						preto = 0;
						teste = false;
					}else if(preto <= (3*TamanhoPadrao)+(TamanhoPadrao/2) && preto >= (3*TamanhoPadrao)-(TamanhoPadrao/2)){
						codigobinario.add("1");
						codigobinario.add("1");
						codigobinario.add("1");
						preto = 0;
						teste = false;
					}else if(preto <= (4*TamanhoPadrao)+(TamanhoPadrao/2) && preto >= (4*TamanhoPadrao)-(TamanhoPadrao/2)){
						codigobinario.add("1");
						codigobinario.add("1");
						codigobinario.add("1");
						codigobinario.add("1");
